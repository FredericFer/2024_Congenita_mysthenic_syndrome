...
new_dend <- rotate(row_dend, order = new_order)
...
draw(ht_list, ht_gap = unit(c(1,2), "cm") ,merge_legend = TRUE, column_title_gp = gpar(fontsize = 16),annotation_legend_list = list(lgd_pvalue,lgd_sig))
...
cpt_perc(EMG_Biopsie$Ephedrine.5)
